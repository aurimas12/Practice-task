...
class BookingViewSetTestCase(TestCase):
    def setUp(self):
        ...
        self.venue = Venue.objects.create(
            name="test venue ", parent_id=1, team_id=self.team
        )
    ...
    def test_create_booking_then_overlapping_booking(self):
        valid_data = {
            "date_from": "2021-04-11T15:46:46.087Z",
            "date_to": "2021-04-22T15:46:46.087Z",
            "bookable_id": 1,
            "participant_id": 1,
        }
        client = APIClient()
...
class TeamVenueViewSetTestCase(TestCase):
    def setUp(self):
